...
//    @Value("${breakpoint.upload.chunkSize}")
    private long CHUNK_SIZE = 5 * 1024 * 1024;

//    @Value("${breakpoint.upload.dir}")
    private final String finalDirPath = "D:/ruoyi/uploadPath/video/";


    public VideoService(@Value("D:/ruoyi/uploadPath") String location) {
...
//            logger.error("初始化root文件夹失败。", e);
     ...
     * @return
     */
    public boolean renameFile(File toBeRenamed, String toFileNewName) throws IOException {
        //检查要重命名的文件是否存在，是否是文件
